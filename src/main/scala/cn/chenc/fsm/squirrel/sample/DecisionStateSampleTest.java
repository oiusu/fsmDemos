...
public class DecisionStateSampleTest {
    ...
    static DecisionStateMachine buildStateMachine() {
...
//        System.out.println(fsm.exportXMLDefinition(true));
    ...
    public static void main(String[] args) {
        ...
        UntypedStateMachineBuilder builder = StateMachineBuilderFactory.create(DecisionStateMachine.class);
        builder.externalTransition().from("A").to("B").on(DecisionEvent.A2B).callMethod("a2b");
        builder.onEntry("B").callMethod("ontoB");

        // 4. Use State Machine
//        UntypedStateMachine fsm = builder.newStateMachine(DecisionState);
        DecisionStateMachine fsm = buildStateMachine();
        fsm.fire(DecisionEvent.A2B, 30);
